 ...
 * English: Frase en inglés.
 * Spanish: Traduccion al español.*/
 ...
 * English: Lista de frase en inglés.
 * EnglishTail: La cola de la frase en inglés.
 * Translation: La lista con el resultado de la traducción.
 ...
 * NounEng: Sustantivo en inglés.
 * Predicate: el resto de la oración (predicado).
 ...
 * ArticleEng: articulo en inglés.
 * AdjEng: adjetivo en inglés.
 * NounEng: sustantivo en inglés.
 * P: predicado, resto de la oración.
 ...
 * NounEng: Pronombre personal en inglés.
 * Predicate: el resto de la oración.
 * NounEsp: Pronombre personal en español.
 * Person: persona gramatical.
 ...
 * Predicate: resto de la oración.
 * ArticleEsp: Articulo en español.
 * Gender: género.
 * Quantity: plural o singular.
 ...
 * AuxEng: Auxiliar en inglés.
 * VerbEng: verbo en inglés.
 * Predicate: predicado de la oración.
 * Result: lista con el resultado de la traducción.
 * Person: persona gramatical.
 * Quantity: plural o singular.*/
 ...
 * VerbEng: Verbo en inglés.
 * Predicate: resto de la oración.
 * VerbEsp: verbo traducido a español.
 * Person:persona gramatical.
 * Quantity: plural o singular.*/
 ...
 * AuxEng: auxiliar en inglés.
 * Predicate: resto de la oración.
 * AuxEsp: auxiliar traducido a español.
 * Person: persona gramatical.
 * Quantity: plural o singular.*/
find_verb([AuxEng|Predicate],Predicate,AuxEsp,Person,Quantity):- aux(AuxEsp,[AuxEng],Person,Quantity,_),!.

/*Traduce el predicado de la oración si es un sustantivo
 *English: predicado en inglés.
 *NounEsp: sustantivo en español*/
 ...
 * Description1: primer descriptivo en inglés.
 * ConjEng: conjunción en inglés.
 * Description2: segunda descripción en inglés.
 * UnionResult: resultado de la traducción.*/
 ...
 * AdjEng: adjetivo en inglés.
 * AdjEsp: adjetivo traducido a español.*/
find_predicate([AdjEng|_],AdjEsp):- adjetivo(AdjEsp,[AdjEng],_,_),!.

/*Detecta si el predicado es una conjunción
 * ConjEng: conjuncion en inglés.
 * ConjEsp: conjuncion en español.*/
 ...
 * English traduccion al inglés.*/
translateEI(Spanish,English):- expression(Spanish,English),!.

/*Determina el sujeto de la oración
 *Spanish: frase en español.
 *English: traduccion al inglés.*/
...
/*traduce el predicado de la oración
 *Spanish: la frase español.
 *English: la traduccion al inglés.
...
/*Busca sujeto articulo + sustantivo
 * DemosEsp: demostrativo en español.
 * NounEsp: sustantivo en español.
 * Predicate: resto de la oracion.
 * Result: resultado de la oracion.
 * t: indicador de sujeto.
 ...
 * VerbEsp: verbo en español.
 * T: resto de la frase.
 * VerbEng: verbo traducido a inglés.
 * Person: persona gramatical.
 * Quantity: plural o singular.*/
...
/*detecta un predicado con la forma Noun/Adj + conj + Noun/Adj
 * Description1: primer descriptivo en español.
 * ConjEsp: conjunción en español.
 * Description2: segunda descripción en español.
 * UnionResult: resultado de la traducción.*/
...
/*Traduce una oracion palabra por palabra Español->Inglés.
...
/*Traduce una oracion palabra por palabra Inglés->Español.
 * L: el resultado de traduccion*/
